...
public class Application {
	...
	public void inscription() {
		...
		while (!saisieOK) {
			...
			try {
				...
				System.out.println("ERR : Le nombre de joueur doit �tre un entier");
				sc.nextLine();
			}
			if (saisieOK) {
		...
		while (i <= nombreDeJoueurs) {
			...
			while (!identification) {
				...
				try {
					...
					System.out.println("Ce mot de passe ne correspond pas � ce nom d'utilisateur, veuillez r�essayer");
				}
			}
	...
	/**
	 * association de 3 tuiles � chaque coin
	 */
	...
	/**
	 * V�rifie si les coordonn�es correspondent � un coin
	 * @param xColonie
	 * @param yColonie
	 * @return
	 */
	...
	/**
	 * V�rifie si le coin est libre de tout joueur
	 * @param xColonie
	 * @param yColonie
	 * @return
	 */
	private boolean checkLibre(int xColonie, int yColonie) {
		System.out.println("INF : V�rification de la libre occupation du coin");
	...
	/** 
	 * return true si les coins sont occup�s
	 * @param xColonie
	 * @param yColonie
	 * @return
	 */
