...
<<<<<<< HEAD
  ...
  @Autowired
	...
	@Transactional
	public String getNouvellePartie(Model model,
			HttpSession session) {
		...
		//creation de la partie, ajout de l'utilisateur (si pas deja fait) et enregistrement de la nouvelle liste Joueurs
		...
		int i = 0;
		//recuperation du joueur mis a jour avec sa partie, pour chaque joueur de la partie envoyer dans la session pour affichage
