...
public class SseService {
	...
	public SseEmitter gestionEmitters(){
		...
		//action � faire quand l'event est complet
		...
		emitter.onCompletion(() -> {
			...
			// en effet, elle peut �tre utilis�e par plusieurs thread. Il faut qu'elle soit disponible avant d'y supprimer
			// un �l�ment
	...
	// le message peut �tre un string ou un objet.
	// avec Jackson, c'est objet devrait �tre automatiquement transcrit au format json
